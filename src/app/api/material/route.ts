...
export async function POST(req: NextRequest) {
  try {
      ...
      messages: [
        {
          role: "system",
          content:
            "You are simulating a student with a learning disability, trying to answer test questions based on provided study material.",
        },
        {
          role: "user",
          content: prompt,
    ...
    return NextResponse.json({
      output,
      extractedTextLength: material.length,
